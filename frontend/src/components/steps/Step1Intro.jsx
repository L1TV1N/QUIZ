  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl text-center">
        ...
        >
          <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800 border border-blue-100 dark:border-blue-900 mb-8">
            <div className="space-y-4 text-left">
              <div className="flex items-start gap-3">
                <span className="text-2xl">🏠</span>
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">Адаптирующиеся вопросы</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Квиз подстраивается под ваши ответы</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl">🤖</span>
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">AI анализ</h3>
